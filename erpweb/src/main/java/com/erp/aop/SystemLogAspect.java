...
import com.erp.utils.UuidUtils;
...
public class SystemLogAspect {
	...
	private static final ThreadLocal<Emp> currentUser=new NamedThreadLocal<>("ThreadLocal emp");
...
/*	@Pointcut("@annotation(com.myron.ims.annotation.SystemServiceLog)")
	 ...
	 * Controller层切点 注解拦截
	 */
	@Pointcut("@annotation(com.erp.annotation.SystemControllerLog)")
	...
	public void doAfter(JoinPoint joinPoint) {
    	...
    	log.setUserId(emp.getEid().toString());
