			...
			[
			 	{
					...
					[
						{"icon":"icon-sys","menuid":"101","menuname":"商品类型管理","url":"/dept/dept_list"}	,
						{"icon":"icon-sys","menuid":"102","menuname":"商品管理","url":"/emp/toEmp"}
					]
			 	}
...
$(function(){
    ...
    //获取菜单数据
	$.ajax({
		//url:'menu/queryMenuTree?pid=0',
		url:'menu/queryMenuTreeBtEmpId',
		type:'post',
		dataType:'json',
       ...
       // shadow: true,
		...
		buttons:[
			{text:'保存',iconCls:'icon-save',handler:function(){
				 ...
				 if($newPwd != $reNewPwd){
				 	$.messager.alert('提示','二次输入的密码不一致','info');
				 	return ;
				 }
