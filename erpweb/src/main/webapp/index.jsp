                ...
                $.ajax({
                    ...
                    success:function(data){
                        if(data.success){
                            ...
                            $.messager.alert('失败',data.message,info);
                        }
                    }
                })
            });
...
<div region="north" split="true" border="false" style="overflow: hidden; height: 30px;
    ...
    <span style="float:right; padding-right:20px;" class="head">欢迎 <span id="username">${loginUser.username}</span>  <a href="#" id="editpass">修改密码</a> <a href="#" id="loginOut">安全退出</a></span>
